...
1. Επιτρέπεται, αλλά και ενθαρρύνεται, η ανταλλαγή απόψεων σχετικά με τις προς εκπόνηση εργασίες, αλλά απαγορεύεται η διακίνηση υλικού (προγραμμάτων, εγγράφων, κλπ.) που αποτελούν τμήματα εργασιών προς εκπόνηση στα πλαίσια των υποχρεώσεων του μαθήματος.
