...
Ερωτήσεις για διαδικαστικά, το μάθημα και τις ασκήσεις αποκλειστικά στο [Piazza](https://piazza.com/uoa.gr/fall2023/197af) - απαιτεί di.uoa.gr email. Δεν έχεις ακόμα di.uoa.gr email; Βεβαιώσου ότι συμπλήρωσες την φόρμα στην [Συμμετοχή](#Συμμετοχή) και θα σου στείλουμε πρόσκληση.

## Τμήματα Εργαστηρίων

Γραφτείτε στο τμήμα εργαστηρίου που ταιριάζει στο πρόγραμμά σας μέσω [eclass](https://eclass.uoa.gr/modules/group/index.php?course=DI631&urlview=1) - απαιτεί di.uoa.gr email. Δεν έχεις ακόμα di.uoa.gr email; Βεβαιώσου ότι συμπλήρωσες την φόρμα στην [Συμμετοχή](#Συμμετοχή) και θα προσπαθήσουμε να σε συμπεριλάβουμε στην λίστα.

Το εργαστήριο είναι *υποχρεωτικό* για τους πρωτοετείς. Το ακόλουθο πρόγραμμα θα ξεκινήσει την Δευτέρα 09/10/2023:

1. Δευτέρα 13:00-15:00 @ Εργαστήριο Windows PC1, υπεύθυνος: Μίλτος Κυριακάκος
1. Δευτέρα 15:00-17:00 @ Εργαστήριο Windows PC1, υπεύθυνος: Μίλτος Κυριακάκος
1. Δευτέρα 17:00-19:00 @ Εργαστήριο Windows PC1, υπεύθυνη: Γιάννης Χαμόδρακας
1. Τετάρτη 15:00-17:00 @ Εργαστήριο Windows PC1, υπεύθυνος: Άννα Καββαδά
1. Τετάρτη 17:00-19:00 @ Εργαστήριο Windows PC1, υπεύθυνος: Γιάννης Χαμόδρακας
1. Παρασκευή 13:00-15:00 @ Εργαστήριο Windows PC1, υπεύθυνος: Νίκος Περδικοπάνης
1. Παρασκευή 15:00-17:00 @ Εργαστήριο Windows PC1, υπεύθυνος: Στέφανος Σταματης
1. Παρασκευή 17:00-19:00 @ Εργαστήριο Windows PC1, υπεύθυνος: Νίκος Περδικοπάνης
1. Τμήμα Β+: Τρίτη 18:00-20:00 @ Εργαστήριο Linux, υπεύθυνος: Δημήτρης Βερλέκης
