...
**ΣΗΜΑΝΤΙΚΟ**: Για να βαθμολογηθείς στο μάθημα, **πρέπει** να συμπληρώσεις τα στοιχεία σου σε αυτήν την [φόρμα](https://forms.gle/kD9ydhXd6qMHGc4v6) - απαιτεί λογαριασμό Gmail.

Είσαι από μετεγγραφή και περιμένεις ακόμα αριθμό μητρώου; Δες τις [Συχνές Ερωτήσεις](./faq.md#μετεγγραφές) και συμπλήρωσε την φόρμα παραπάνω.
...
Το εργαστήριο είναι **υποχρεωτικό** για τους πρωτοετείς. Το ακόλουθο πρόγραμμα θα ξεκινήσει στις 5 Οκτωβρίου 2026:
...
* Αναπροσαρμογή: Αν ο βαθμός από τις Ασκήσεις είναι πάνω από 3 μονάδες μεγαλύτερος του βαθμού από τις Γραπτές Εξετάσεις, τότε ο βαθμός για τις Ασκήσεις αναπροσαρμόζεται σε `Γραπτές Εξετάσεις + 3`.
...
* [AI Study Guide](https://progintro.github.io/study/): οδηγός μελέτης βασισμένος στις διαλέξεις,
  ...
  φαίνεται σωστό, επιβεβαιώστε με τους διδάσκοντες.
* [Sea](https://progintro.github.io/sea/): C compiler που τρέχει ολόκληρος μέσα στον browser -
  γράφετε, μεταγλωττίζετε και τρέχετε C χωρίς να εγκαταστήσετε τίποτα. Ιδανικό για να
  δοκιμάσετε κάτι γρήγορα· για τις εργασίες ελέγχετε πάντα με την εντολή μεταγλώττισης της
  εκφώνησης.
...
* Αναστάσης Τριανταφύλλου (anastasist)
* Καλλιόπη Δεσποτίδου (kdespotidou)
* Παύλος Νταής (pntais)
